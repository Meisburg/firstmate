...
| `fm-lesson.sh`           | Supervisor-side intake for worker-reported durable lessons: list unreviewed ones, show one, and record the reviewed outcome; the stow path files only curated lessons into `data/learnings.md` |
