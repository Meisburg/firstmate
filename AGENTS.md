...
Both crewmate scaffolds also require one worker-reported durable lesson at done in `data/<id>/lesson.md`; `bin/fm-lesson.sh` owns the supervisor-side intake and the stow path files only curated lessons into `data/learnings.md`.
